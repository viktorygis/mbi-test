//#region node_modules/imask/esm/core/utils.js
...
function forceDirection(direction) {
	switch (direction) {
		case DIRECTION.LEFT: return DIRECTION.FORCE_LEFT;
		case DIRECTION.RIGHT: return DIRECTION.FORCE_RIGHT;
...
//#endregion
//#region node_modules/imask/esm/core/action-details.js
...
var ActionDetails = class {
	...
	constructor(opts) {
		...
		if (this.insertedCount) while (this.value.slice(this.cursorPos) !== this.oldValue.slice(this.oldSelection.end)) if (this.value.length - this.cursorPos < this.oldValue.length - this.oldSelection.end) ++this.oldSelection.end;
		else ++this.cursorPos;
	}
...
//#endregion
//#region node_modules/imask/esm/core/holder.js
/** Applies mask on element */
function IMask(el, opts) {
	return new IMask.InputMask(el, opts);
}
//#endregion
//#region node_modules/imask/esm/masked/factory.js
...
function normalizeOpts(opts) {
	...
	if (IMask.Masked) {
		if (opts.prototype instanceof IMask.Masked) return { mask: opts };
		const { mask = void 0, ...instanceOpts } = opts instanceof IMask.Masked ? { mask: opts } : isObject(opts) && opts.mask instanceof IMask.Masked ? opts : {};
		if (mask) {
...
//#endregion
//#region node_modules/imask/esm/controls/mask-element.js
...
//#endregion
//#region node_modules/imask/esm/controls/html-mask-element.js
var KEY_Z = 90;
var KEY_Y = 89;
...
//#endregion
//#region node_modules/imask/esm/controls/html-input-mask-element.js
...
IMask.HTMLMaskElement = HTMLMaskElement;
//#endregion
//#region node_modules/imask/esm/controls/html-contenteditable-mask-element.js
...
//#endregion
//#region node_modules/imask/esm/controls/input-history.js
...
//#endregion
//#region node_modules/imask/esm/controls/input.js
...
//#endregion
//#region node_modules/imask/esm/core/change-details.js
...
//#endregion
//#region node_modules/imask/esm/core/continuous-tail-details.js
...
//#endregion
//#region node_modules/imask/esm/masked/base.js
/** Append flags */
/** Extract flags */
/** Provides common masking stuff */
var Masked = class Masked {
	/** */
	/** */
	...
	splice(start, deleteCount, inserted, removeDirection, flags) {
		...
		if (eagerRemove && removeDirection !== DIRECTION.NONE && oldRawValue === this.rawInputValue) {
			if (removeDirection === DIRECTION.FORCE_LEFT) {
				let valLength;
				while (oldRawValue === this.rawInputValue && (valLength = this.displayValue.length)) details.aggregate(new ChangeDetails({ tailShift: -1 })).aggregate(this.remove(valLength - 1));
...
Masked.DEFAULTS = { skipInvalid: true };
Masked.EMPTY_VALUES = [
	void 0,
	null,
	""
...
IMask.Masked = Masked;
//#endregion
//#region node_modules/imask/esm/masked/pattern/chunk-tail-details.js
var ChunksTailDetails = class ChunksTailDetails {
	...
	extend(tailChunk) {
		...
		if (tailChunk instanceof ContinuousTailDetails) if (extendLast) lastChunk.extend(tailChunk.toString());
		else this.chunks.push(tailChunk);
	...
	appendTo(masked) {
		if (!(masked instanceof IMask.MaskedPattern)) return new ContinuousTailDetails(this.toString()).appendTo(masked);
		const details = new ChangeDetails();
		for (let ci = 0; ci < this.chunks.length; ++ci) {
			...
			} else details.aggregate(masked.append(chunk.toString(), { tail: true }));
		}
		return details;
	}
	get state() {
...
//#endregion
//#region node_modules/imask/esm/masked/pattern/cursor.js
...
//#endregion
//#region node_modules/imask/esm/masked/pattern/fixed-definition.js
var PatternFixedDefinition = class {
	...
	nearestInputPos(cursorPos, direction) {
		...
		switch (direction) {
			case DIRECTION.LEFT:
			case DIRECTION.FORCE_LEFT: return minPos;
			case DIRECTION.NONE:
	...
	_appendChar(ch, flags) {
		...
		const isResolved = this.char === ch && (this.isUnmasking || flags.input || flags.raw) && (!flags.raw || !appendEager) && !flags.tail;
		const details = new ChangeDetails({
			inserted: this.char,
...
//#endregion
//#region node_modules/imask/esm/masked/pattern/input-definition.js
var PatternInputDefinition = class {
	...
	nearestInputPos(cursorPos, direction) {
		...
		switch (direction) {
			case DIRECTION.LEFT:
			case DIRECTION.FORCE_LEFT: return this.isComplete ? boundPos : minPos;
			case DIRECTION.RIGHT:
			case DIRECTION.FORCE_RIGHT: return this.isComplete ? boundPos : maxPos;
			case DIRECTION.NONE:
...
//#endregion
//#region node_modules/imask/esm/masked/regexp.js
/** Masking by RegExp */
...
//#endregion
//#region node_modules/imask/esm/masked/pattern.js
/** Pattern mask */
...
//#endregion
//#region node_modules/imask/esm/masked/range.js
...
var MaskedRange = class extends MaskedPattern {
	...
	*/
	...
	doValidate(flags) {
		...
		if (str.search(/[^0]/) === -1 && str.length <= this._matchFrom) return true;
...
//#endregion
//#region node_modules/imask/esm/masked/date.js
var DefaultPattern = "d{.}`m{.}`Y";
/** Date mask */
var MaskedDate = class MaskedDate extends MaskedPattern {
...
//#endregion
//#region node_modules/imask/esm/masked/dynamic.js
/** Dynamic mask for choosing appropriate mask in run-time */
var MaskedDynamic = class MaskedDynamic extends Masked {
	constructor(opts) {
		super({
...
//#endregion
//#region node_modules/imask/esm/masked/enum.js
/** Pattern which validates enum values */
var MaskedEnum = class MaskedEnum extends MaskedPattern {
	constructor(opts) {
		super({
			...MaskedEnum.DEFAULTS,
			...opts
	...
	remove(fromPos, toPos) {
		...
		let pos;
		for (pos = fromPos; pos >= 0; --pos) if (this.enum.filter((e) => this.matchValue(e, this.value.slice(matchFrom, pos), matchFrom)).length > 1) break;
...
//#endregion
//#region node_modules/imask/esm/masked/function.js
...
//#endregion
//#region node_modules/imask/esm/masked/number.js
var _MaskedNumber;
/** Number mask */
var MaskedNumber = class MaskedNumber extends Masked {
	/** Single char */
	/** Single char */
	...
	remove(fromPos, toPos) {
		...
		return new ChangeDetails({ tailShift: (this._separatorsCountFromSlice(valueBeforePos) - prevBeforeTailSeparatorsCount) * this.thousandsSeparator.length });
	}
	nearestInputPos(cursorPos, direction) {
...
//#endregion
//#region node_modules/imask/esm/masked/pipe.js
...
IMask.pipe = pipe;
//#endregion
//#region node_modules/imask/esm/masked/repeat.js
/** Pattern mask */
var RepeatBlock = class extends MaskedPattern {
	...
	_appendCharRaw(ch, flags) {
		if (flags === void 0) flags = {};
		const details = new ChangeDetails();
		for (let bi = (_this$_mapPosToBlock$ = (_this$_mapPosToBlock = this._mapPosToBlock(this.displayValue.length)) == null ? void 0 : _this$_mapPosToBlock.index) != null ? _this$_mapPosToBlock$ : Math.max(this._blocks.length - 1, 0), block, allocated; block = (_this$_blocks$bi = this._blocks[bi]) != null ? _this$_blocks$bi : allocated = !allocated && this._allocateBlock(bi); ++bi) {
	...
	_trimEmptyTail(fromPos, toPos) {
		...
		let removeCount = 0;
		for (let blockIndex = lastBlockIndex; firstBlockIndex <= blockIndex; --blockIndex, ++removeCount) if (this._blocks[blockIndex].unmaskedValue) break;
		if (removeCount) {
...
//#endregion
//#region node_modules/imask/esm/index.js
try {
	globalThis.IMask = IMask;
} catch {}
//#endregion
export { ChangeDetails, ChunksTailDetails, DIRECTION, HTMLContenteditableMaskElement, HTMLInputMaskElement, HTMLMaskElement, InputMask, MaskElement, Masked, MaskedDate, MaskedDynamic, MaskedEnum, MaskedFunction, MaskedNumber, MaskedPattern, MaskedRange, MaskedRegExp, PIPE_TYPE, PatternFixedDefinition, PatternInputDefinition, RepeatBlock, createMask, createPipe, IMask as default, forceDirection, normalizeOpts, pipe };
